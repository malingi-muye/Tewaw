      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 text-balance">
            Premium Apparel for Every Need
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            From corporate uniforms to casual wear, we offer a comprehensive range of high-quality cotton and fleece
            apparel. All products are customizable with your branding.
          </p>
        </div>
      </div>
    </section>
